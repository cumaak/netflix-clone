...
function Series() {
  const [backdrop, setBackdrop] = useState("")
    ...
    useEffect(
      () => {
        const fetcData = async function (){
          const res = await fetch("https://api.themoviedb.org/3/trending/tv/day?language=tr&api_key=3e6922e5aba1aa821b670146c1f3876a&page=1")
    ...
    useEffect(
      () => {
        const fetcData = async function (){
          const res = await fetch("https://api.themoviedb.org/3/trending/tv/day?language=tr&api_key=3e6922e5aba1aa821b670146c1f3876a&page=2")
          const data = await res.json()
    ...
    useEffect(
      () => {
        const fetcData = async function (){
          const res = await fetch("https://api.themoviedb.org/3/trending/tv/day?language=tr&api_key=3e6922e5aba1aa821b670146c1f3876a&page=3")
          const data = await res.json()
    ...
    useEffect(
      () => {
        const fetcData = async function (){
          const res = await fetch("https://api.themoviedb.org/3/genre/tv/list?language=tr&api_key=3e6922e5aba1aa821b670146c1f3876a")
          const data = await res.json()
  ...
  return (
    <main>
      <GenreSelector section={"Diziler"} genres={genres}/>
